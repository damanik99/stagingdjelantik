        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form id="shipmentInbound" method="post">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="text-center mt-5">
                                <a href="<?= base_url('/ShipmentInbound'); ?>" class="btn btn-default-light">Cancel</a>
...
$('#buyer_id').change(function () {
    ...
    if(buyer_id != ''){
        ...
        // Driver
        $.get("<?= base_url('shipment/get_driver/') ?>/" + buyer_id, function(response){
        ...
        // Vehicle
        $.get("<?= base_url('shipment/get_vehicle/') ?>/" + buyer_id, function(response){
            let option = '<option value=""> -- Select Driver -- </option>';
...
$(document).ready(function () {
    ...
    $('#shipmentInbound').submit(function(e) {
        e.preventDefault();
        ...
        $.ajax({
            url: "<?= base_url('/shipmentinbound/savecreate'); ?>",
            type: "POST",
            data: $(this).serialize(),
            dataType: "json",
