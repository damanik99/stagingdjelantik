...
<div class="app-content">
    <div class="side-app">
        ...
        <div class="page-header">
            <div class="mr">
                <a href="<?=base_url()?>shipment/index" class="btn btn-radius btn-default mr-2">
                    <span>
        ...
        <div class="page-headersxd">
            <div>
                <h1 class="page-title">Data Shipment Type Inbound</h1>
            </div>
            <div class="ml-auto pageheader-btn">
                <a href="<?=base_url()?>ShipmentInbound/create" class="btn btn-success-light btn-icon mr-2">
                    <span>
...
$(document).ready(function () {
    ...
    $('#shipmentTable').DataTable({
        ...
        ajax: {
            url: "<?= base_url('shipmentinbound/datatables') ?>",
            type: "POST"
        },
